...
firstTaxiRisk <- firstTaxiAvg %>% 
  ...
  mutate(speedRiskLevel = case_when(
                               avgDifference < summary(firstTaxiAvg1$`avgDifference`)[1] + ((summary(firstTaxiAvg1$`avgDifference`)[6] - summary(firstTaxiAvg1$`avgDifference`)[1])*0.1) & avgDifference > 0 ~ "10",
                               avgDifference < summary(firstTaxiAvg1$`avgDifference`)[1] + ((summary(firstTaxiAvg1$`avgDifference`)[6] - summary(firstTaxiAvg1$`avgDifference`)[1])*0.2) & avgDifference > 0 ~ "9",
                               avgDifference < summary(firstTaxiAvg1$`avgDifference`)[1] + ((summary(firstTaxiAvg1$`avgDifference`)[6] - summary(firstTaxiAvg1$`avgDifference`)[1])*0.3) & avgDifference > 0 ~ "8",
                               avgDifference < summary(firstTaxiAvg1$`avgDifference`)[1] + ((summary(firstTaxiAvg1$`avgDifference`)[6] - summary(firstTaxiAvg1$`avgDifference`)[1])*0.4) & avgDifference > 0 ~ "7",
                               avgDifference < summary(firstTaxiAvg1$`avgDifference`)[1] + ((summary(firstTaxiAvg1$`avgDifference`)[6] - summary(firstTaxiAvg1$`avgDifference`)[1])*0.5) & avgDifference > 0 ~ "6",
                               avgDifference < summary(firstTaxiAvg1$`avgDifference`)[1] + ((summary(firstTaxiAvg1$`avgDifference`)[6] - summary(firstTaxiAvg1$`avgDifference`)[1])*0.6) & avgDifference > 0 ~ "5",
                               avgDifference < summary(firstTaxiAvg1$`avgDifference`)[1] + ((summary(firstTaxiAvg1$`avgDifference`)[6] - summary(firstTaxiAvg1$`avgDifference`)[1])*0.7) & avgDifference > 0 ~ "4",
                               avgDifference < summary(firstTaxiAvg1$`avgDifference`)[1] + ((summary(firstTaxiAvg1$`avgDifference`)[6] - summary(firstTaxiAvg1$`avgDifference`)[1])*0.8) & avgDifference > 0 ~ "3",
                               avgDifference < summary(firstTaxiAvg1$`avgDifference`)[1] + ((summary(firstTaxiAvg1$`avgDifference`)[6] - summary(firstTaxiAvg1$`avgDifference`)[1])*0.9) & avgDifference > 0 ~ "2",
                               avgDifference < summary(firstTaxiAvg1$`avgDifference`)[1] + ((summary(firstTaxiAvg1$`avgDifference`)[6] - summary(firstTaxiAvg1$`avgDifference`)[1])*1.0) & avgDifference > 0 ~ "1",
                               avgDifference <= 0 ~ "10")) %>% 
  arrange(as.numeric(speedRiskLevel))
firstTaxiRisk
```
```{r}
firstTaxiRiskAvg <- firstTaxiRisk %>% 
  group_by(vehicleid) %>% 
